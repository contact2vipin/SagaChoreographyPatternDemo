...
public class KafkaConsumerConfig {
    ...
    @Bean
    ConsumerFactory<String, InventoryReservedEvent> inventoryReservedConsumerFactory(KafkaProperties kafkaProperties) {
        return consumerFactory(kafkaProperties, InventoryReservedEvent.class);
    }

    @Bean
    ConcurrentKafkaListenerContainerFactory<String, InventoryReservedEvent> inventoryReservedKafkaListenerContainerFactory(
